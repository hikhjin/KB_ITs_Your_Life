<template>
    <nav class="navbar navbar-expand-md bg-dark navbar-dark mt-2">
        ...
        <div :class="navClass">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <!--router-link : 라우트 페이지를 이동(리랜더링)시키기 위한 명령-->
                ...
                <li class="nav-item">
                    <router-link class="nav-link" to="/param?param1=test1&param2=test2">Param</router-link>
                </li>
                <li class="nav-item">
                    <router-link class="nav-link" to="/members">멤버</router-link>
                </li>
                <li class="nav-item">
                    <router-link class="nav-link" to="/notfound">없는페이지</router-link>
                </li>
                <li class="nav-item">
